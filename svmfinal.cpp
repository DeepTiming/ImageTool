...
int main(int argc, char** argv)
{
	const char* keys =
	{
		...
		"{pd    |  E:\\LeaperFiles\\MachineLearningData\\personData\\personPos  | path of directory contains possitive images}"
		"{nd    |  E:\\LeaperFiles\\MachineLearningData\\personData\\negphoto  | path of directory contains negative images}"
		"{td    |  E:\\LeaperFiles\\MachineLearningData\\personData\\littletestpos | path of directory contains test images}"
	...
	test_trained_detector(obj_det_filename, test_dir);	//检测训练集
