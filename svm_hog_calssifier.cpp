//https://blog.csdn.net/k87974/article/details/78583501?locationNum=8&fps=1
//VS+Opencv3.3下用HOG+SVM
...
int main(int argc, char** argv)
{
	const char* keys =
	{
		...
		"{pd    |  E:\\LeaperFiles\\MachineLearningData\\MLself\\NewPointPos\\看图王批量图片转换结果  | path of directory contains possitive images}"
		"{nd    |  E:\\LeaperFiles\\MachineLearningData\\MLself\\NewPointNes\\看图王批量图片转换结果  | path of directory contains negative images}"
		"{td    |  E:\\LeaperFiles\\MachineLearningData\\MLself\\TestPointnes   | path of directory contains test images}"
	...
	svm->save("svm_train_09291506.xml");
	clog << "...[done]" << endl;
